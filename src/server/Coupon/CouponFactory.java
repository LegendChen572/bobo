...
public class CouponFactory {
     ...
     */
    public static /* synthetic */ int getNXCodeSize(String a) {
        /*
     ...
     * Exception decompiling
     */
    public static /* synthetic */ boolean getNXCodeValid(String a, boolean a) {
        /*
         * This method has failed to decompile.  When submitting a bug report, please provide this stack trace, and (if you hold appropriate legal rights) the relevant class file.
     ...
     * Exception decompiling
     */
    public static /* synthetic */ int getNXCodeTime(String a) {
        /*
         * This method has failed to decompile.  When submitting a bug report, please provide this stack trace, and (if you hold appropriate legal rights) the relevant class file.
         * org.benf.cfr.reader.util.ConfusedCFRException: Tried to end blocks [4[TRYBLOCK]], but top level block is 7[TRYBLOCK]
         * org.benf.cfr.reader.bytecode.analysis.opgraph.Op04StructuredStatement.processEndingBlocks(Op04StructuredStatement.java:429)
    ...
    public /* synthetic */ CouponFactory() {
        CouponFactory a2;
    }
     ...
     * Exception decompiling
     */
    public static /* synthetic */ Triple<Boolean, Integer, Integer> getNXCodeInfo(String a) {
        /*
         * This method has failed to decompile.  When submitting a bug report, please provide this stack trace, and (if you hold appropriate legal rights) the relevant class file.
     ...
     * Exception decompiling
     */
    public static /* synthetic */ void setNXCodeUsed(String a, String a) throws SQLException {
        /*
         * This method has failed to decompile.  When submitting a bug report, please provide this stack trace, and (if you hold appropriate legal rights) the relevant class file.
     ...
     * Exception decompiling
     */
    public static /* synthetic */ boolean getNXCodeExist(String a) {
        /*
         * This method has failed to decompile.  When submitting a bug report, please provide this stack trace, and (if you hold appropriate legal rights) the relevant class file.
     ...
     * Exception decompiling
     */
    public static /* synthetic */ void CreateNXCode_Center(String a, int a, int a, int a, int a) throws SQLException {
        /*
         * This method has failed to decompile.  When submitting a bug report, please provide this stack trace, and (if you hold appropriate legal rights) the relevant class file.
     ...
     * Exception decompiling
     */
    public static /* synthetic */ int getNXCodeType(String a) {
        /*
         * This method has failed to decompile.  When submitting a bug report, please provide this stack trace, and (if you hold appropriate legal rights) the relevant class file.
         * org.benf.cfr.reader.util.ConfusedCFRException: Tried to end blocks [4[TRYBLOCK]], but top level block is 7[TRYBLOCK]
         * org.benf.cfr.reader.bytecode.analysis.opgraph.Op04StructuredStatement.processEndingBlocks(Op04StructuredStatement.java:429)
     ...
     */
    public static /* synthetic */ void CreateNXCode(String a2, int a32, int a4, int a5) throws SQLException {
        ...
        block17: {
            block16: {
                ...
                try {
                    ...
                    preparedStatement2 = druidPooledConnection2.prepareStatement(StatsHandling.ALLATORIxDEMO("g5}>|/\u000e2`/a[N\u0015V\u0018A\u001fK\u001b\u000eSN\u0018A\u001fK\u001b\u0002[N\rO\u0017G\u001fNW\u000e\u001b[\bK\tNW\u000e\u001bZ\u0002^\u001eNW\u000e\u001bG\u000fK\u0016NW\u000e\u001b]\u0012T\u001eNW\u000e\u001bZ\u0012C\u001eNR\u000e-o7{>}[\u0006D\u0002[\tJ\tW\u000e5{7bW\u000eD\u0002[\u0011W\u000eD\u0002[\tV\u001f\\\u0007"));
                    try {
                        preparedStatement = preparedStatement2;
                        n3 = 3;
                        PreparedStatement preparedStatement3 = preparedStatement2;
                        preparedStatement3.setString(1, a2);
                        preparedStatement3.setInt(2, a32);
                        n2 = a32 == 3 ? a4 : a5;
                    }
                    ...
                    FilePrinter.printError(MonsterGlobalDropEntry.ALLATORIxDEMO("-U\u001bJ\u0001T([\rN\u0001H\u0017\u0014\u001aB\u001a"), "CreateNXCode" + sQLException);
                    return;
                }
                catch (Throwable throwable) {
                ...
                {
                    int a32;
                    preparedStatement2.setInt(4, a32 == 3 ? a5 : 1);
                    PreparedStatement preparedStatement4 = preparedStatement2;
                    preparedStatement4.execute();
                    preparedStatement4.close();
                    if (preparedStatement2 == null) break block16;
                    druidPooledConnection = druidPooledConnection2;
                }
                preparedStatement2.close();
                break block17;
     ...
     * Exception decompiling
     */
    public static /* synthetic */ int getNXCodeItem(String a) {
        /*
         * This method has failed to decompile.  When submitting a bug report, please provide this stack trace, and (if you hold appropriate legal rights) the relevant class file.
         * org.benf.cfr.reader.util.ConfusedCFRException: Tried to end blocks [4[TRYBLOCK]], but top level block is 7[TRYBLOCK]
         * org.benf.cfr.reader.bytecode.analysis.opgraph.Op04StructuredStatement.processEndingBlocks(Op04StructuredStatement.java:429)
